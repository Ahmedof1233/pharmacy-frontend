    ...
    <style type="text/css">
      {`
        @media print {
          ...
          /* تنسيق صفحة الملصق الواحد - 6cm عرض × 4cm طول */
          .sticker-print-page {
          ...
          /* أحجام الخطوط المضبوطة لمقاس 6×4 سم */
          .sticker-text-col { display: flex; flex-direction: column; justify-content: center; align-items: flex-end; flex: 1; padding-right: 1.5mm; gap: 1mm; }
          .sticker-qr-col   { display: flex; flex-direction: column; align-items: center; justify-content: center; flex-shrink: 0; }
          .p-title  { font-size: 7pt;   font-weight: bold; margin: 0;  line-height: 1.3; }
          .p-name   { font-size: 7.5pt; font-weight: bold; margin: 0;  line-height: 1.3; }
          .p-med    { font-size: 7pt;   font-weight: 900;  margin: 0;  line-height: 1.3; }
          .p-dos    { font-size: 6.5pt; font-weight: 600;  margin: 0;  line-height: 1.3; }
          .p-scan   { font-size: 5.5pt; margin: 1.5mm 0 0 0; line-height: 1.2; text-align: center; }
          .qr-img   { width: 3.2cm !important; height: 3.2cm !important; display: block; }
        }
      `}
    </style>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 font-sans flex justify-center items-center">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
        ...
        {/* قسم طلب أدوية إضافية */}
        <div className="mt-6 pt-5 border-t border-gray-100">
          <p className="text-center text-sm font-semibold text-gray-500 mb-3">
            🛒 عايز تطلب أي دواء تاني؟
          </p>
          <div className="flex gap-3">
            {/* زر الواتساب المباشر */}
            <a
              href={`https://wa.me/+966595643148?text=${encodeURIComponent('مرحباً، أريد الاستفسار عن دواء')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-3 px-3 rounded-xl transition-all shadow-md shadow-emerald-100 text-sm"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-3 rounded-xl transition-all shadow-md shadow-blue-100 text-sm"
            >
              <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18zm0 0c-2.5 0-4.5-4-4.5-9s2-9 4.5-9m0 18c2.5 0 4.5-4 4.5-9s-2-9-4.5-9M3.5 9h17M3.5 15h17"/>
              </svg>
              <span>موقعنا</span>
            </a>
          </div>
